...
//                this.parentNode.parentNode.childNodes[1].innerText = v*0.9;
        ...
        editable: {
            ...
            validate: function (v) {
                ...
                if(parseFloat(v)>=parseFloat(this.parentNode.parentNode.childNodes[0].innerText)){
                	return '请输入小于'+this.parentNode.parentNode.childNodes[0].innerText+'的数值';
                }
            },
            onblur: 'submit'
        },
...
//	    str+='<div style="padding-left: 15px;font-size:14px; width: 620px;padding-top: 20px;margin-top: 20px;">';
	    if($("#alarmType").val() == "1") {
	    	...
	    	str += '<div class="row-fluid">';
	    		str += '<div class="span2">';
	    	 str+='<span_customer2>光照上限值</span_customer2></div><div class="span2"> <input type="text" onblur="setWarning(3);" style="width: 90px;margin-top: -3px;margin-left:-10px;" name="high_lux" id="high_lux" value="0"/></div>';   
	    	 str += '<div class="span2">';
	    	 str+='<span_customer2>光照上限警示</span_customer2></div><div class="span2"> <input type="text" style="width: 90px;margin-top: -3px;margin-left:-10px;" name="high_lux_warning" id="high_lux_warning" value="0"/></div>';   
	    	 str += '<div class="span2">';
	    	 ...
	    	 str += '<div class="row-fluid">';
	    		str += '<div class="span2">';
	    	 str+='<span_customer2>光照下限值</span_customer2></div><div class="span2"><input type="text" style="width: 90px;margin-top: -3px;margin-left:-10px;" onblur="setWarning(4);" name="low_lux" id="low_lux" value="0"/></div> ';   
	    	 str += '<div class="span2">';
	    	 str+='<span_customer2>光照下限警示</span_customer2></div><div class="span2"><input type="text" style="width: 90px;margin-top: -3px;margin-left:-10px;" name="low_lux_warning" id="low_lux_warning" value="0"/></div> ';   
	    	 str += '<div class="span2">';
